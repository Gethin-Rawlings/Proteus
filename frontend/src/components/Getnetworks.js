...
const urlForNetworks  = network => 'http://ec2-52-56-248-133.eu-west-2.compute.amazonaws.com:5000/organisations?type=network'
    ...
    componentDidMount() { 
        ...
        .then(response => { 
           ...
           render() { 
             ...
             return (
                   <select name = "network" form="form" className="selectBox" onChange={this.handleChange}>
